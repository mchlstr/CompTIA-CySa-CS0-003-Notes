...
`<one of: Detected / Investigating / Contained / Eradicating / Recovering / Closed>`
...
`<2-3 sentences in plain language: what happened, what we know, what we're doing>`
...
- **Confirmed:** `<list>`
- **Working hypothesis:** `<list>`
- **Unknown / investigating:** `<list>`

## Communications status

- Internal leadership: `<notified at HH:MM | pending>`
- Affected business owners: `<status>`
- Legal / Privacy: `<engaged at HH:MM>`
- Customers: `<not yet / draft prepared / sent at HH:MM>`
- Regulators: `<assessment pending / clock started at HH:MM>`
- Law enforcement: `<engaged / not engaged>`
